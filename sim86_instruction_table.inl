...
//Variants of arithmetic instructions
...
// Variants of Logic instructions
...
// Variants of String instructions
...
// Variants of Processor control instructions
INST(clc, {B(11111000)})
INST(cmc, {B(11110101)})
INST(stc, {B(11111001)})
INST(cld, {B(11111100)})
